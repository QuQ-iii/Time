...
async function india() {
  ...
  var hrAngle = map((hr % 12) + 21, 0,60,0,360);
...
async function dubai() {
  ...
  var hrAngle = map((((hr - 1) % 12) + 21), 0,60,0,360);
...
async function america() {
  ...
  var hrAngle = map((america_hr % 12) + 21, 0,60,0,360);
...
async function australia() {
  ...
  var hrAngle = map((australia_hr % 12) + 21, 0,60,0,360);
